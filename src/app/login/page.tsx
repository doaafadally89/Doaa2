      ...
      <div className="w-full max-w-md">
        ...
        <div className="mb-8 text-center">
          <Link href="/" className="inline-flex items-center gap-2">
            ...
            <span className="text-2xl font-bold text-foreground">ShipCheck</span>
          </Link>
        ...
        <div className="rounded-2xl border border-border bg-white p-8 shadow-sm">
          ...
          <button
            ...
            className="mb-6 flex w-full items-center justify-center gap-3 rounded-xl border border-border py-3 text-sm font-medium text-foreground hover:bg-surface transition-colors"
          >
